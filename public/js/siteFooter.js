...
(function(){
    ...
    if(document.querySelector('[data-lp-ad]')){
        ...
        s.src='/js/adSlots.js?v=1776666769';
        s.defer=true;
    ...
    if(!window.LpRecent){
        ...
        rr.src='/js/recentResults.js?v=1776666769';
    ...
    if(!isGamePage){
        ...
        pwa.src='/js/pwaInstall.js?v=1776666769';
        pwa.defer=true;
    ...
    if(window.supabase){
        ...
        rr2.src='/js/lpRoom.js?v=1776666769';
        rr2.defer=true;
