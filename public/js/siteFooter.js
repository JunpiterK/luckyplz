...
(function(){
    ...
    if(document.querySelector('[data-lp-ad]')){
        ...
        s.src='/js/adSlots.js?v=1776734435';
        s.defer=true;
    ...
    if(!window.LpRecent){
        ...
        rr.src='/js/recentResults.js?v=1776734435';
    ...
    if(!isGamePage){
        ...
        pwa.src='/js/pwaInstall.js?v=1776734435';
        pwa.defer=true;
    ...
    if(window.supabase){
        ...
        rr2.src='/js/lpRoom.js?v=1776734435';
        rr2.defer=true;
    ...
    if(window.supabase&&!isGamePage&&!window.LpSocial){
        ...
        ls.src='/js/lpSocial.js?v=1776734435';
        ls.defer=true;
