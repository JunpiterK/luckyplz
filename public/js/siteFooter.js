...
(function(){
    ...
    if(document.querySelector('[data-lp-ad]')){
        ...
        s.src='/js/adSlots.js?v=1776735966';
        s.defer=true;
    ...
    if(!window.LpRecent){
        ...
        rr.src='/js/recentResults.js?v=1776735966';
    ...
    if(!isGamePage){
        ...
        pwa.src='/js/pwaInstall.js?v=1776735966';
        pwa.defer=true;
    ...
    if(window.supabase){
        ...
        rr2.src='/js/lpRoom.js?v=1776735966';
        rr2.defer=true;
        document.body.appendChild(rr2);
    }

    /* Social layer (friends + DM) — loaded on home + auth + messages so
       the unread-bell + friend API are callable. Games skip it to keep
       their bundle lean. */
    if(window.supabase&&!isGamePage&&!window.LpSocial){
        var ls=document.createElement('script');
        ls.src='/js/lpSocial.js?v=1776735966';
        ls.defer=true;
    ...
    if(window.supabase&&!isGamePage&&!window.LpNotify){
        ...
        ln.src='/js/lpNotify.js?v=1776735966';
        ln.defer=true;
