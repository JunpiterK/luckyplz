...
(function(){
    ...
    if(document.querySelector('[data-lp-ad]')){
        ...
        s.src='/js/adSlots.js?v=1776692692';
        s.defer=true;
    ...
    if(!window.LpRecent){
        ...
        rr.src='/js/recentResults.js?v=1776692692';
    ...
    if(!isGamePage){
        ...
        pwa.src='/js/pwaInstall.js?v=1776692692';
        pwa.defer=true;
    ...
    if(window.supabase){
        ...
        rr2.src='/js/lpRoom.js?v=1776692692';
        rr2.defer=true;
