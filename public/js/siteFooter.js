...
(function(){
    ...
    if(!window.LpFullscreen){
        ...
        fs.src='/js/lpFullscreen.js?v=1781999960';
    ...
    if(!window.LpInAppExit){
        ...
        ia.src='/js/lpInAppExit.js?v=1781999960';
        ia.defer=true;
    ...
    if(isGamePage&&!window.LpBgm){
        ...
        bgm.src='/js/lpBgm.js?v=1781999960';
        bgm.defer=true;
    ...
    if(isGamePage&&!window.LpWakeLock){
        ...
        wl.src='/js/lpWakeLock.js?v=1781999960';
        document.body.appendChild(wl);
    }
    if(isGamePage&&!window.LpPhaseTimer){
        var pt=document.createElement('script');
        pt.src='/js/lpPhaseTimer.js?v=1781999960';
    ...
    if(document.querySelector('[data-lp-ad]')){
        ...
        s.src='/js/adSlots.js?v=1781999960';
        s.defer=true;
    ...
    if(!window.LpRecent){
        ...
        rr.src='/js/recentResults.js?v=1781999960';
    ...
    if(!isGamePage){
        ...
        pwa.src='/js/pwaInstall.js?v=1781999960';
        pwa.defer=true;
    ...
    if(window.supabase){
        ...
        rr2.src='/js/lpRoom.js?v=1781999960';
        rr2.defer=true;
        ...
        hc.src='/js/lpHostCtl.js?v=1781999960';
        hc.defer=true;
        ...
        mp.src='/js/lpMultiplayer.js?v=1781999960';
        mp.defer=true;
    ...
    if(window.supabase&&!window.LpSocial){
        ...
        ls.src='/js/lpSocial.js?v=1781999960';
        ls.defer=true;
    ...
    if(window.supabase&&!window.LpActivity){
        ...
        la.src='/js/lpActivity.js?v=1781999960';
        la.defer=true;
        la.onload=function(){
    ...
    if(window.supabase&&!window.LpPresence){
        ...
        lp.src='/js/lpPresence.js?v=1781999960';
        lp.defer=true;
    ...
    if(window.supabase&&!window.LpInvite){
        ...
        li.src='/js/lpInvite.js?v=1781999960';
        li.defer=true;
    ...
    if(window.supabase&&isGamePage&&!window.LpInviteButton){
        ...
        lib.src='/js/lpInviteButton.js?v=1781999960';
        lib.defer=true;
    ...
    if(window.supabase&&!isGamePage&&!window.LpNotify){
        ...
        ln.src='/js/lpNotify.js?v=1781999960';
        ln.defer=true;
    ...
    if(isBlogPost && !window.LpReadingAids){
        ...
        ra.src = '/js/blogReadingAids.js?v=1781999960';
        ra.defer = true;
