...
(function(){
    ...
    if(document.querySelector('[data-lp-ad]')){
        ...
        s.src='/js/adSlots.js?v=1776732817';
        s.defer=true;
    ...
    if(!window.LpRecent){
        ...
        rr.src='/js/recentResults.js?v=1776732817';
    ...
    if(!isGamePage){
        ...
        pwa.src='/js/pwaInstall.js?v=1776732817';
        pwa.defer=true;
    ...
    if(window.supabase){
        ...
        rr2.src='/js/lpRoom.js?v=1776732817';
        rr2.defer=true;
    ...
    if(window.supabase&&!isGamePage&&!window.LpSocial){
        ...
        ls.src='/js/lpSocial.js?v=1776732817';
        ls.defer=true;
