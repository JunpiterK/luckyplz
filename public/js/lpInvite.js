...
(function(){
    ...
    const IV_I18N = {
        ko:{friend:'친구',head:'🎮 게임 초대',bodyFmt:'{nick}님이 {game} 에 초대했어요!',
            ...
            games:{lotto:'로또',roulette:'룰렛',ladder:'사다리',dice:'주사위',team:'팀 나누기',bingo:'빙고','car-racing':'카레이싱',yut:'윷놀이',ludo:'루도',reversi:'리버시','prism-hex':'프리즘 헥스'}},
        en:{friend:'A friend',head:'🎮 Game invite',bodyFmt:'{nick} invited you to {game}!',
            ...
            games:{lotto:'Lotto',roulette:'Roulette',ladder:'Ladder',dice:'Dice',team:'Team Picker',bingo:'Bingo','car-racing':'Car Racing',yut:'Yut Nori',ludo:'Ludo',reversi:'Reversi','prism-hex':'Prism Hex'}},
        ja:{friend:'友だち',head:'🎮 ゲーム招待',bodyFmt:'{nick}さんが{game}に招待しました！',
            ...
            games:{lotto:'ロト',roulette:'ルーレット',ladder:'あみだくじ',dice:'サイコロ',team:'チーム分け',bingo:'ビンゴ','car-racing':'カーレース',yut:'ユンノリ',ludo:'ルドー',reversi:'リバーシ','prism-hex':'プリズムヘックス'}},
        es:{friend:'Un amigo',head:'🎮 Invitación a jugar',bodyFmt:'¡{nick} te invita a jugar {game}!',
            ...
            games:{lotto:'Lotería',roulette:'Ruleta',ladder:'Escalera',dice:'Dados',team:'Equipos',bingo:'Bingo','car-racing':'Carrera',yut:'Yut Nori',ludo:'Ludo',reversi:'Reversi','prism-hex':'Prism Hex'}},
        pt:{friend:'Um amigo',head:'🎮 Convite de jogo',bodyFmt:'{nick} está te chamando pra jogar {game}!',
            ...
            games:{lotto:'Loteria',roulette:'Roleta',ladder:'Escada',dice:'Dados',team:'Times',bingo:'Bingo','car-racing':'Corrida',yut:'Yut Nori',ludo:'Ludo',reversi:'Reversi','prism-hex':'Prism Hex'}}
    };
    function IVT() {
