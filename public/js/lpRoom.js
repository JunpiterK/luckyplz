    ...
    function showHomeJoinModal(opts){
        ...
        const lastCard=(function(){
            try{
                ...
                _lastRoom=lr;
                const gnames={roulette:'룰렛',ladder:'사다리',team:'팀뽑기',lotto:'로또',bingo:'빙고','car-racing':'레이싱',quiz:'퀴즈',yut:'윷놀이',ludo:'루도',reversi:'리버시',gummy:'구미 체인','prism-hex':'프리즘 헥스'};
        ...
        async function doJoin(){
            ...
            const _validGames=['roulette','ladder','team','lotto','bingo','car-racing','quiz','ludo','yut','reversi','gummy','bubble','prism-hex'];
