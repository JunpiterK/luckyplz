...
window.BLOG_POSTS = [
    ...
    excerpt: "KOSPI는 반도체 대형주 랠리에 힘입어 8,047.51로 +2.55% 급등 마감했다. SK하이닉스가 +5.72% 폭등하며 ₩2,052,000을 기록했고 현대차 +5.19%, HD현대중공업 +9.56% 급등세를 보였다. 외국인은 코스피에서 -3,224억원 순매도했으나 기관의 +4,582억원 순매수가 지수를 떠받쳤다. KO",
    ...
    excerpt: "KOSPI closed at 8,047.51, up +2.55%, driven by a powerful semiconductor rally. SK Hynix surged +5.72% to ₩2,052,000 and Hyundai Motor jumped +5.19%, while HD Hyundai Heavy Industri",
    ...
    excerpt: "KOSPIは半導体大型株ラリーに支えられ8,047.51で+2.55%急騰して引けた。SKハイニックスが+5.72%暴騰し₩2,052,000を記録、現代自動車+5.19%、HD現代重工業+9.56%急騰。外国人はKOSPIで-3,224億ウォン純売却したが機関投資家の+4,582億ウォン純買いが指数を下支え。KOSDAQは+0.98%上昇し1,172.52",
    alt: 'kr-tech-recap-2026-05-26',
    ...
    excerpt: "KOSPI在半导体大型股拉升下以8,047.51收盘，上涨+2.55%。SK海力士暴涨+5.72%至₩2,052,000，现代汽车+5.19%，HD现代重工业飙升+9.56%。外资在KOSPI净卖出-3,224亿韩元，但机构净买入+4,582亿韩元支撑指数。KOSDAQ上涨+0.98%至1,172.52收盘。USD/KRW下跌-0.50%至1,505.23，",
    alt: 'kr-tech-recap-2026-05-26',
