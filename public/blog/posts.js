...
window.BLOG_POSTS = [
    ...
    title: "기술주 반도체 강세에 2.6% 급등, WTI 3.2% 폭락·다우 0.23% 하락",
    excerpt: "미국 증시는 월요일 반도체 강세로 기술주가 급등한 반면 원유 3.2% 폭락으로 에너지가 무너지며 뚜렷한 차별화 양상을 보였다. S&P 500은 0.61% 상승해 7,519.12에 마감했으며, 필라델피아 반도체 지수가 5.53% 급등하며 XLK를 2.63% 끌어올렸다. 나스닥 종합지수는 1.19% 상승했고 러셀 2000은 ",
    ...
    title: "Tech Surges 2.6% on Semi Strength; Oil Plunges 3.2%, Dow Slips",
    excerpt: "US stocks split sharply Monday as tech roared on semiconductor strength while energy cratered on crude's 3.2% plunge. The S&P 500 rose 0.61% to 7,519.12, powered by a 5.53% surge i",
    ...
    title: "ハイテク株が半導体主導で2.6%急伸、原油3.2%急落・ダウ0.23%安",
    excerpt: "米国株式市場は月曜、半導体の強さでハイテク株が急伸した一方、原油3.2%急落でエネルギーセクターが崩れ、明確な二極化を見せた。S&P 500は0.61%上昇し7,519.12で取引を終え、フィラデルフィア半導体指数が5.53%急伸してXLKを2.63%押し上げた。ナスダック総合指数は1.19%上昇、ラッセル2000は1.79%上昇したが、ダウはエネルギーとヘ",
    alt: 'us-tech-recap-2026-05-26',
    ...
    coverEmoji: '🇺🇸',
    tags: ["每日复盘", "美股", "韩股", "科技"],
    title: "科技股半导体带动涨2.6%，油价暴跌3.2%、道指跌0.23%",
    excerpt: "美国股市周一呈现鲜明分化，科技股因半导体强势飙升，而能源股因原油暴跌3.2%重挫。标普500指数上涨0.61%至7,519.12点，费城半导体指数暴涨5.53%带动XLK上涨2.63%。纳斯达克综合指数跳涨1.19%，罗素2000上涨1.79%，但道指因能源和医疗保健拖累下跌0.23%。WTI原油因伊朗局势缓和暴跌3.18%至$93.53，拖累XLE下跌2.",
    alt: 'us-tech-recap-2026-05-26',
