...
window.BLOG_POSTS = [
    ...
    title: "KOSPI 0.41% 상승 마감, KOSDAQ 4.99% 급등",
    excerpt: "지난 금요일(5/22) KOSPI는 0.41% 상승 마감했으나, 삼성전자는 -2.34% 하락. KOSDAQ은 4.99% 급등하며 배터리·2차전지 종목 강세. 에코프로비엠 +10.77%, 삼성SDI +5.03%, POSCO Future M +4.74% 등 배터리 밸류체인 전반 상승. 미국 SOX 지수 +1.99%로 반도체 ",
    ...
    title: "KOSPI +0.41%, KOSDAQ surges +4.99% on battery rally",
    excerpt: "KOSPI closed +0.41% on Friday (5/22), but Samsung Electronics fell -2.34%. KOSDAQ surged +4.99% on battery sector strength. Ecopro BM +10.77%, Samsung SDI +5.03%, POSCO Future M +4",
    ...
    title: "KOSPI +0.41%、KOSDAQ +4.99% 急騰",
    excerpt: "金曜日(5/22)KOSPI +0.41%で引けたが、サムスン電子は-2.34%下落。KOSDAQは+4.99%急騰、バッテリー・2次電池株が牽引。エコプロBM +10.77%、サムスンSDI +5.03%、POSCO Future M +4.74%など電池バリューチェーン全般上昇。米SOX +1.99%で半導体は好環境も、サムスンは個別売り。本日(5/26",
    alt: 'kr-open-brief-2026-05-26',
    ...
    coverEmoji: '🇰🇷',
    tags: ["每日复盘", "美股", "韩股", "科技"],
    title: "KOSPI +0.41%，KOSDAQ 暴涨 +4.99%",
    excerpt: "上周五(5/22)KOSPI收涨+0.41%，但三星电子跌-2.34%。KOSDAQ暴涨+4.99%，电池与二次电池板块领涨。Ecopro BM +10.77%、三星SDI +5.03%、POSCO Future M +4.74%等电池价值链全线上涨。美国SOX +1.99%对半导体友好，但三星遭遇个股抛压。今日(5/26)开盘面临混合信号：美元/韩元1,5",
    alt: 'kr-open-brief-2026-05-26',
