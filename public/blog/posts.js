...
window.BLOG_POSTS = [
    ...
    },
    {
        ...
        readMinutes: 8,
        coverEmoji: '🇺🇸',
        tags: ['미국증시', 'CPI', '인플레이션', '반도체 차익실현', '데일리 리캡', 'lucky please'],
        title: '美 5/12 마감 — CPI 쇼크에 INTC -10%·AMD -5% 차익실현',
        excerpt: '4월 CPI +3.8% YoY 쇼크 + 10Y 4.46% 1년 신고가 → 5월 +35% 폭등한 INTC·AMD 차익실현 폭락. QCOM -12% 2020 이후 최악. NVDA·TSLA 만 강세.',
    ...
    },
    {
        ...
        readMinutes: 8,
        coverEmoji: '🇺🇸',
        tags: ['US Markets', 'CPI Shock', 'Intel Selloff', 'Daily Recap', 'lucky please'],
        title: 'US Tech Recap May 12 — Hot CPI Triggers Chip Sell-off',
        excerpt: 'April CPI +3.8% YoY + 10Y to 4.46% 1-yr high → INTC -10%, AMD -5%, QCOM -12% profit-taking. NVDA +2%, TSLA +3.9% lone bulls.',
