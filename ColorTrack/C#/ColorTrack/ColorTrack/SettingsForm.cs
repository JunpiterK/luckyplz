...
namespace ColorTrack
{
    public partial class SettingsForm : Form
    {
        ...
        public Dictionary<int, bool> BlackbodyIntervals { get; set; } = new Dictionary<int, bool>();

        private CheckBox _showBackgroundCheckBox = new CheckBox();
        private CheckBox _showBoundariesCheckBox = new CheckBox();
        private TrackBar _alphaTrackBar = new TrackBar();
        private Label _alphaLabel = new Label();
        private CheckBox[] _blackbodyCheckBoxes = new CheckBox[4];
