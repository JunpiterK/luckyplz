...
-- =====================================================================
-- Symptom this fixes:
--   When the snake / pacman / tetris / dodge / burger game-over overlay
--   shows "🛠 랭킹 시스템 점검 중" and the browser console reports 404s
--   on record_*_attempt / *_records / *_my_stats / *_rank_info /
--   *_leaderboard, that means the per-game tables/RPCs aren't deployed
