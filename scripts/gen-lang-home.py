...
LANGS["es"] = dict(
    ...
    description="Seis sorteos aleatorios gratis: ruleta de nombres, generador de equipos, dados, bingo, carrera aleatoria y escalera. Sin registro, funciona en cualquier celular y se comparte con un toque.",
    ...
    faq=[
        ...
        ("¿Funciona en el celular?",
         "Sí. Todo está diseñado primero para pantalla de celular en vertical y escala a tabletas y computadoras, así que puedes pasar un celular por la mesa o poner la misma página en un proyector."),
