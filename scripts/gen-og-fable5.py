...
LANGS = {
    "":    {"font": "malgunbd.ttf", "sub": "프론티어를 둘로 나누다 · 벤치마크 비교"},
    "-en": {"font": "arialbd.ttf",  "sub": "The Frontier, Split in Two · Benchmarked"},
    "-ja": {"font": "YuGothB.ttc",  "sub": "フロンティアを二つに · ベンチマーク"},
    "-zh": {"font": "msyhbd.ttc",   "sub": "把前沿一分为二 · 基准对比"},
}
...
def build(lang_suffix, subtitle):
    ...
    chips = ["SWE-bench Pro  80.3", "$10 / $50  per Mtok"]
    # measure total
    widths = []
    for c in chips:
    ...
    out = OG / f"claude-fable-5{lang_suffix}.png"
...
def main():
    ...
    print("Generating Fable 5 OG images:")
